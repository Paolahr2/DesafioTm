...
@Component({
  ...
  template: `
    <div class="dashboard-container">
      ...
      <mat-toolbar class="dashboard-header gradient-bg">
        <div class="flex justify-between align-center full-width">
          <div class="flex items-center space-x-3">
            <div class="tm-logo-dashboard">
              <div class="logo-text-relief-small">TM</div>
            </div>
            <h1 class="text-2xl font-bold text-white" style="margin: 0;">TaskManager</h1>
          </div>
      ...
      <div class="dashboard-content p-6" style="background: linear-gradient(135deg, #00bcd4 0%, #4caf50 50%, #2196f3 100%); min-height: calc(100vh - 80px);">
      ...
      <mat-menu #userMenu="matMenu">
        <div class="p-4" style="border-bottom: 1px solid rgba(102, 126, 234, 0.1); background: linear-gradient(145deg, #ffffff 0%, #f8f9ff 100%);">
          <div class="flex items-center space-x-3">
            ...
            <div>
              <p class="font-semibold text-gray-800" style="margin: 0;">{{ currentUser?.name || currentUser?.username }}</p>
  ...
  styles: [`
    ...
    .gradient-bg {
      background: linear-gradient(45deg, #00bcd4 30%, #2196f3 70%, #4caf50 90%);
    }

    /* Logo TM para Dashboard */
    .tm-logo-dashboard {
      display: flex;
      align-items: center;
    ...
    /* Botón principal con colores azules armoniosos */
    .btn-primary {
    ...
    @keyframes pulse {
      ...
      50% { box-shadow: 0 6px 16px rgba(25, 118, 210, 0.5); }
