...
@Component({
  ...
  template: `
    <div class="landing-container">
      ...
      <nav class="navbar">
        <div class="nav-content">
          <div class="nav-inner">
            ...
            <!-- logo taskmanagerswo con swo destacado -->
            <div class="logo-section">
              <div class="logo-icon-modern">
                <div class="logo-gradient-bg">
                  <span class="logo-swo-modern">SWO</span>
                </div>
              </div>
              <h1 class="logo-text-modern">TaskManagerSWO</h1>
            </div>
        ...
        <div class="hero-content">
          ...
          <div class="welcome-banner">
            <h1 class="welcome-title">
              Bienvenido a <span class="brand-highlight">TaskManagerSWO</span>
            </h1>
          ...
          <div class="hero-text-section">
            <h2 class="hero-title">
              <span class="hero-highlight">Organiza</span>, <span class="hero-highlight">Colabora</span> y <span class="hero-highlight">Triunfa</span>
            </h2>
            
            <!-- subtitulo centrado -->
            <p class="hero-subtitle">
              <strong>Gestiona proyectos</strong> con tableros Kanban intuitivos<br>
            ...
            <div class="cta-buttons">
              <button mat-flat-button routerLink="/register" class="cta-primary">
      ...
      <!-- caracteristicas principales estilo trello -->
        ...
        <div class="use-cases-content">
          ...
          <div class="use-cases-grid">
            ...
            <div class="use-case-item">
              ...
              <h3>Empresas</h3>
              <p>Escala para empresas grandes con características avanzadas de gestión y reporting.</p>
            </div>
  ...
  styles: [`
    ...
    .logo-gradient-bg {
      width: 44px;
      height: 44px;
      background: linear-gradient(135deg, #0079bf 0%, #026aa7 50%, #005a8b 100%);
      border-radius: 12px;
      display: flex;
      align-items: center;
      justify-content: center;
      box-shadow: 0 4px 12px rgba(0, 121, 191, 0.3),
                  0 2px 4px rgba(0, 121, 191, 0.1);
    ...
    .logo-text-modern {
      ...
      text-shadow: 0 1px 2px rgba(0, 121, 191, 0.1);
    }
    ...
    .label.green { 
      background: linear-gradient(135deg, #70b500 0%, #8cc814 100%); 
    }
    .label.blue { 
      background: linear-gradient(135deg, #0079bf 0%, #026aa7 100%); 
    }
    ...
    .demo-label.green { background: #70b500; }
    ...
    .demo-avatar:nth-child(2) { background: #70b500; }
    ...
    .use-case-icon.small-team { background: linear-gradient(135deg, #dbeafe, #93c5fd); }
    .use-case-icon.large-team { background: linear-gradient(135deg, #f3e8ff, #c084fc); }
    .use-case-icon.personal { background: linear-gradient(135deg, #dcfce7, #86efac); }
    .use-case-icon.projects { background: linear-gradient(135deg, #fed7aa, #fb923c); }
